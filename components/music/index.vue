        ...
        <div class="player__top">
          <div class="player-cover">
            <transition-group :name="transitionName">
                <div class="player-cover__item" v-show="$index === currentTrackIndex" :style="{ backgroundImage: `url(${track.cover})` }"  v-for="(track, $index) in tracks" :key="track.id"></div>
            </transition-group>
          </div>
      ...
      tracks: [
		 {
          ...
          source: 'https://music.163.com/song/media/outer/url?id=569213220.mp3',
          url: '#',
          favorited: true
        },
        {
          ...
          name: 'Mekanın Sahibi',
          artist: 'Norm Ender',
          cover: 'https://p1.music.126.net/gNbAlXamNjhR2j3aOukNhg==/109951164232796511.jpg',
